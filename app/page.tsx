...
export default function Home() {
  return (
    <section className="flex flex-col justify-center items-center min-h-screen bg-white dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <div className="mt-8 flex justify-center gap-x-5 gap-y-3 max-sm:flex-col">
          ...
          <Link
            className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-white text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-11 px-8"
        ...
        {/* Avantages clés */}
        <div className="mt-10">
          <h2 className="text-white text-2xl font-bold mb-4">Avantages clés</h2>
          <ul className="list-disc list-inside text-left text-gray-600 dark:text-gray-400">
